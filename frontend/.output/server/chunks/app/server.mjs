...
const appHead = { "meta": [{ "name": "viewport", "content": "width=device-width, initial-scale=1" }, { "charset": "utf-8" }], "link": [], "style": [], "script": [], "noscript": [], "charset": "utf-8", "viewport": "width=device-width, initial-scale=1", "title": "NetID" };
...
const _routes = [
  {
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/about-a67570a7.mjs').then((m) => m.default || m)
  },
  {
    name: "index",
    path: "/",
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/index-148fcfb7.mjs').then((m) => m.default || m)
  },
  {
    name: "pokus",
    path: "/pokus",
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/pokus-1cd8e133.mjs').then((m) => m.default || m)
  }
];
...
const _imports_0 = "" + __publicAssetsURL("img/netid.png");
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs) {
  ...
  _push(`<div${ssrRenderAttrs(mergeProps({ id: "top" }, _attrs))}><header><nav><ul><li>`);
  ...
  _push(ssrRenderComponent(_component_NuxtLink, { to: "/" }, {
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        _push2(`<img${ssrRenderAttr("src", _imports_0)} alt=""${_scopeId}> NetID`);
      } else {
        return [
          createVNode("img", {
            src: _imports_0,
          ...
          createTextVNode(" NetID")
        ];
      }
    }),
    _: 1
  }, _parent));
  _push(`</h1></header><main>`);
...
const _sfc_main = {
  ...
  setup(__props) {
    const ErrorComponent = /* @__PURE__ */ defineAsyncComponent(() => import('./_nuxt/error-component-dc8854d8.mjs').then((r) => r.default || r));
...
export { _export_sfc as _, useNuxtApp as a, __nuxt_component_0 as b, createError as c, entry$1 as default, useHead as u };
